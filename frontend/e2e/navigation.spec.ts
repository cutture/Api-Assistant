...
test.describe('Navigation', () => {
  test('should navigate to all main pages', async ({ page }) => {
    ...
    // Home page should redirect to chat
  ...
  test('should display logo and title', async ({ page }) => {
    ...
    await expect(page.getByText(/coding agent/i)).toBeVisible();
  });
  ...
  test('should navigate back to home from logo', async ({ page }) => {
    ...
    // Click logo to go home (redirects to chat)
    await page.getByText(/coding agent/i).click();
